...
// const indexerMethodMap = require('../indexerMethodMap.json')
...
function execRPC(method, params) {
  logger.info(`Calling POSS RPC method: ${method}, params: ${JSON.stringify(params)}`)
  ...
  logger.info(`Calling POSS RPC method: ${rpcData.rpcMethod}, request options:`)
